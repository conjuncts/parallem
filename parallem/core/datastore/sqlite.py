...
class SQLiteDatastore(BaseDatastore):
    ...
    def __init__(self, file_manager: FileManager):
        ...
        self.responses_table = ResponsesTable()
    ...
    def _setup_main_table(self, conn: sqlite3.Connection) -> None:
        ...
        self.responses_table.create(conn)
        ...
        self.responses_table.create_indexes(conn)
        _ensure_legacy_responses_alias(conn)
    
        self.metadata_table.create_indexes(conn)
        self.batch_pending_table.create_indexes(conn)
        self.errors_table.create_indexes(conn)
